...
var PgConnectionArgCondition = function PgConnectionArgCondition(builder) {
  builder.hook("init", (_, build) => {
    ...
    introspectionResultsByKind.class.forEach(table => {
      ...
      newWithHooks(GraphQLInputObjectType, {
        ...
        __origin: `Adding condition type for ${describePgEntity(table)}. You can rename the table's GraphQL type via a 'Smart Comment':\n\n  ${sqlCommentByAddingTags(table, {
          name: "newNameHere"
        })}`,
    ...
    return _;
  }, ["PgConnectionArgCondition"], [], ["PgTypes"]);
        ...
        pgQuery: queryBuilder => {
          if (condition != null) {
            relevantAttributes.forEach(attr => {
              ...
              if (val != null) {
                queryBuilder.addLiveCondition(() => record => record[attr.name] === val);
                ...
                queryBuilder.addLiveCondition(() => record => record[attr.name] == null);
...
exports.default = PgConnectionArgCondition;
