<template>
  <div class="row q-col-gutter-md justify-center">
    ...
    <template v-else>
      <div class="column col q-gutter-md justify-start align-center" style="max-width: 850px" :key="idx" v-for="(column, idx) in columns">
...
export default {
  ...
  computed: {
    ...
    columns() {
      const columns = Array(this.columnCount).fill(0).map(() => []);
